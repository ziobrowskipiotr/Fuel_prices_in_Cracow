...
public class DataPb98 {
	
	private static Logger logger = LogManager.getLogger(DataPb98.class.getName());
	...
	public DataPb98(String name, String address, String brand, String pb98) {
