...
public class Controller_Pb98 {
    
    @FXML
    private TableView<DataPb98> tableView1;
    @FXML
    private TableColumn<DataPb98, String> nameColumn1;
    @FXML
    private TableColumn<DataPb98, String> addressColumn1;
    @FXML
    private TableColumn<DataPb98, String> brandColumn1;
    @FXML
    private TableColumn<DataPb98, String> pb98Column1;
   
    private static final Logger projectLogger = LogManager.getLogger(Controller_Pb98.class);
    private Scene scene;
    private Stage stage;
    ...
    public void initialize() {
        ...
        pb98Column1.setCellValueFactory(cellData -> cellData.getValue().pb98Property());
